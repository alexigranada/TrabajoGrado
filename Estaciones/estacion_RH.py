...
Exploración dato Humedad Relativa de las estaciones del IDEAM
...
'''Cargamos datos'''
ruta = 'Datos/IDEAM/Estaciones Dagua IDEAM/VA_hora/Hum_Rel_UNIVERSIDAD DEL PACIFICO - AUT   [5311500056].csv'
...
fig = go.Figure()
fig.add_trace(go.Scatter(x=time, y=valor, mode='lines', name='Hum. Relativa'))

fig.update_layout(title=f'Humedad Relativa estación: {name}',
                  title_x= 0.5)
fig.show()

''' Exportar el DataFrame a un archivo CSV '''
title = f'RH_hora_{name}.csv'
