...
rutadia = 'D:/Python_TG/Estaciones/Precipitación diaria.csv' #Ruta del archivo
...
estacion_dia = nombre_estacion_dia.get_group(str(grupo_estaciones_dia[0][0]))

''' Creamos el formato de la fecha'''
fechaformato_dia = "%d/%m/%Y %H:%M"
